    ...
    >
        ...
        <template #default>
            ...
            >
                <template v-slot:content-id="props">
                    <div class="flex items-center">
                        <div class="flex-shrink-0 h-10 w-10">
                            <img
                                v-if="props.item.display_url"
                                :src="props.item.display_url"
                ...
                <template v-slot:content-title="props">
    ...
    setup() {
        ...
        const table = reactive({
            headers: {
                ...
                title: trans("Title"),
                visibility_status: trans("Visibility"),
